...
from app.agents.logistics.base import BaseAgent, AgentResult
...
from app.services.logistics.memory.context import context_manager
...
def _compute_real_metrics(fb: dict) -> dict:
    ...
    from app.services.logistics.tools.route_tool import _haversine_km, _resolve_city
...
def _build_fallback_replan(fb: dict, crisis_context: dict) -> dict:
    ...
    from app.services.logistics.tools.route_tool import AIRPORTS, PORTS, _haversine_km, _resolve_city
...
class OrchestratorAgent(BaseAgent):
    ...
    async def run(self, task_id: uuid.UUID, task_title: str,
        ...
        from app.services.logistics.tools.weather_tool import live_weather, disaster_check
